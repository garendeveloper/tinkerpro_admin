            ...
            <div class="card p-0" style="height: 78vh; width: 100%;">
              ...
              <table>
                <thead class="productHeader">
                  <tr>
                    <th class="text-center font-size" style="width: 10px;">No.</th>
                    <th class="text-center font-size" style="width: 300px;">Name</th>
                    <th class="text-center font-size" style="width: 150px;">Barcode</th>
                    <th class="text-center font-size" style="width: 120px;">SKU</th>
                    <th class="text-center font-size" style="width: 120px;">Code</th>
                    <th class="text-center font-size" style="width: 120px;">Unit</th>
                    <th class="text-center font-size" style="width: 120px;">Brand</th>
                    <th class="text-center font-size" style="width: 120px;">Price (Php)</th>
                    <th class="text-center font-size" style="width: 120px;">Mark-up (%)</th>
                    <th class="text-center font-size" style="width: 120px;">Cost (Php)</th>
                    <th class="text-center font-size" style="width: 220px;">Category</th>
                    <th class="text-center font-size" style="width: 120px;">Status</th>
                    <th class="text-center font-size" style="width: 150px;">Action</th>
                  </tr>
                </thead> 
              </table>

              <div id="responsive-data" style="height: 100%;">
                <table id="recentusers" class="text-color table-border" style="table-layout: fixed;">
