<style>
 #show_stockhistoryPrintModal  .modal-dialog {
  max-width: 1000px; 
  min-width: 500px; 
...
#show_stockhistoryPrintModal .modal-content {
  color: #ffff;
  background: #262625;
  border-radius: 0;
  position: relative;
...
#show_stockhistoryPrintModal .close-button {
  position: absolute;
  right: 1.6em;
  top: 10px;
  background: #FF6900;
...
#show_stockhistoryPrintModal .modal-title {
...
#show_stockhistoryPrintModal .warning-container {
  display: flex;
  align-items: center;
}

#show_stockhistoryPrintModal .warning-container svg {
  width: 35px;
  height: 35px;
  margin-right: 0.5em;
  margin-left: 1em;
...
<div class="modal" id="show_stockhistoryPrintModal"  tabindex="0" style="background-color: rgba(0, 0, 0, 0.7); overflow: hidden; z-index: 2199;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="warning-container">
          ...
          <p class="warning-title"><b>SHOW STOCK HISTORY REPORT</b></p>&nbsp;
        </div>
      </div>
    ...
    <div hidden id="pdfFile1"class="pdf-viewer-container">
...
$(document).ready(function() {
  ...
  $('#show_stockhistoryPrintModal #reportsClose').on('click', function() {
      $('#show_stockhistoryPrintModal').hide();
      $('#pdfViewer1').attr('src', '');
