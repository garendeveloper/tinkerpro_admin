          ...
          <div id="tab3" class="tabcontent">
            ...
            <div class="fieldContainer"  >
              <div class="form-group" >
                  <label for="_to_pay"  class="l_input" style="color: #FF6900; "><strong>Pay: </strong></label>
                  <input type="text" class="p_input" pattern="\d+(\.\d{1,2})?" name="_to_pay" id="_to_pay" oninput="$(this).removeClass('has-error')" autocomplete="off" style = "text-align: right">
              </div>
              <div class="form-group" >
