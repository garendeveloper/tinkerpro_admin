<?php include "layout/admin/category_modal_css.php"; ?>
        ...
        <div class="modal-content categoryAdd">
            <div class="warning-container">
                ...
                <div class="productsHeader">
                    <p class="productsItem">
                        <a href="#" onclick="changeValueInput(this)" class="productsBtn" id="showCategories"><span>+</span>&nbsp;Products</a>
                    </p>
                    <input hidden type="checkbox" id="addCategoryCheckbox" class="forAddCategory"/>
...
$(document).ready(function() {
    ...
    $('#showCategories').click(function() {
        ...
        if (categoriesVisible) {
            getCategories();
            $(this).text('- Products').css('color', 'white');
        } else {
