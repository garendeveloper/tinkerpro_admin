  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content modal-logout" style="background: transparent">
      ...
      <div class="modal-body" id="unlockscreen" style="display: none;">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#fff" class="bi bi-upc-scan" viewBox="0 0 16 16">
        ...
        <input type="password" id="unlockPasswordTxt" placeholder="Scan your ID or enter your password" style="width: 280px; border: 1px solid #d3d3d3; background-color: grey; text-align: center; display: block; margin-left:5px;" autocomplete="off"/>
            <button id = "btnContinueUnlock" style = "background-color: var(--primary-color); height: 43px; font-weight: normal; border-radius: 5px; margin-left: 5px;">CONTINUE</button>
            </div>
