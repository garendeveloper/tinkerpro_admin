<style>
 #show_purchasePrintModal  .modal-dialog {
  max-width: 1000px; 
  min-width: 500px; 
...
#show_purchasePrintModal .modal-content {
  color: #ffff;
  background: #262625;
  border-radius: 0;
  position: relative;
...
#show_purchasePrintModal .close-button {
  position: absolute;
  right: 1.6em;
  top: 10px;
...
#show_purchasePrintModal .modal-title {
...
#show_purchasePrintModal .warning-container {
  display: flex;
  align-items: center;
}

#show_purchasePrintModal .warning-container svg {
  width: 35px;
  height: 35px;
  margin-right: 0.5em;
  margin-left: 1em;
...
<div class="modal" id="show_purchasePrintModal"  tabindex="0" style="background-color: rgba(0, 0, 0, 0.7); overflow: hidden; z-index: 2000;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="warning-container">
          ...
          <p class="warning-title"><b>SHOW PURCHASE ORDER REPORT</b></p>&nbsp;
        </div>
      </div>
