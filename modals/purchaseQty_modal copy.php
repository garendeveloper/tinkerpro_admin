    ...
    <div class="modal-content" id = "purchaseQty_content">
      ...
      <form id = "prod_form">
        <div class="modal-body" >
          <div style = "border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0,0,0,0.1); margin: 0 8px; ">
          <div style = "text-align:center">
            <h5>Enter <b style = 'color: #FF6900'>QUANTITY</b> and supplier <b style = 'color: #FF6900'>RATE</b></h5>

            <h5 id = "product_name">SINANDOMENT</h5>
          </div>
        ...
        <div class="modal-footer" style = ' display: flex;  justify-content: space-between;'>
          ...
          <button  class = "grid-item text-color button" type = "submit"><i class = "bi bi-arrow-right-circle"></i>&nbsp; Continue</button>
        </div>
      </form>
    </div>
  </div>
