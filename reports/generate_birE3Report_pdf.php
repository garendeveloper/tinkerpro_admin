...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 1, 'ANNEX "E-3"', 0, false, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
...
$pdf->SetFont('', 'B', 10);
$maxCellHeight = 5; 
$pdf->Cell(277, 8, "Persons with Disability Sales Book/Report", 1, 0, 'C', true);
$pdf->Ln();
$header = array('Date','Name of Person with Disability (PWD)','PWD ID No.', 'PWD TIN', 'SI / OR Number', 'Sales (Inclusive of VAT)', 'VAT Amount', 'VAT Exempt Sales',  'Discount', 'Net Sales');
...
$items = $birFacade->E_reports(6, $startDate, $endDate);
$pdf->Ln();
$pdf->SetFont('', '', 7);
$maxCellHeight = 5; 
