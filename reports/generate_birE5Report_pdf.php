...
if(count($items) > 0)
{
    foreach ($items as $key =>$item) 
    {
        ...
        $pdf->SetFont('', '', autoAdjustFontSize($pdf, number_format($item['overAllDiscounts'], 2), $headerWidths[8]));
        $pdf->Cell($headerWidths[8], $maxCellHeight, number_format($item['overAllDiscounts'], 2), 1, 0, 'R');
