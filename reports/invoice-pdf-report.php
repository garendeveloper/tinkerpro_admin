...
$pdf->SetTitle('INVOICE Table PDF');
$pdf->SetSubject('INVOICE Table PDF Document');
...
$header = array( 'Invocie #', 'Date', 'Paid Amount', 'Total');
$headerWidths = array(40, 45, 50, 55);
$maxCellHeight = 5; 
...
$pdfPath = $pdfFolder . 'invoiceReport.pdf';
