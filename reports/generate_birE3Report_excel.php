...
$sheet->setCellValue('A12', 'Persons with Disability Sales Book/Report');
$sheet->setCellValue('A13', 'Date');
$sheet->setCellValue('B13', 'Name of Person with Disability (PWD)');
$sheet->setCellValue('C13', 'PWD ID No.');
$sheet->setCellValue('D13', 'PWD TIN');
