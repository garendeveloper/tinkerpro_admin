    ...
    <div class="main-panel">
      <div class="content-wrapper" style="width:100%">
        ...
        <div style="display:flex; width: 100%; height: 100%">
          <div class="cardLeft" style="height:1200px; width: 200vh; border: 1px solid #464646; background-color: #262626; border-radius: 0;">
            <div class="card-body ">
              ...
              <h5 class="headerReport text-color" style="margin-top: 5px; display: flex;align-items: center;">Sales<span  class="line"></span></h5>
               <div class="anchor-container">
                  ...
                  <div id="highlightDiv17" style="width: 100%"><a href="#" onclick=" highlightDiv(17)" class="text-color stocksMovementsAnchrBtn highlightAll allAnchrBtn" style="text-decoration: none;">
          ...
          <div class="cardRight" style="height:1200px; width: 60vh; border: 1px solid #464646; background-color: #262626; border-radius: 0;">
            ...
            <div class="custom-select">
                ...
                <!-- <div class="custom-input" style="margin-top: 20px">
                  <input type="text" id="datepicker"   style="padding-left: 35px; flex: 1;text-align: center;">
                  <svg class="calendar-icon" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M7 10H17M7 14H12M7 3V5M17 3V5M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#ffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                </div> -->
            <a href="#" onclick="openModalDatePicker()"class="custom-input" style="margin-top: 20px">
