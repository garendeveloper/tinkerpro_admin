    ...
    $(document).ready(function () {
      ...
      $(".inventoryCard").off("click").on("click", "#btn_delete_lossanddamage", function(){
        var id = $(this).data('id');
        var reason = $(this).closest("tr").find("td:eq(2)").text();
        if(reason === "Expiring Soon" || reason === "Expired Products")
        {
          show_damageResponse("Unable to delete this damage. It was generated by the system.");
          return;
        }
      ...
      function show_damageResponse(message) {
        toastr.options = {
          "onShown": function () {
            $('.custom-toast').css({
              "opacity": 1,
            ...
            if (loss_and_damage_length > 0) {
              ...
              if (validateTableInputs(table_id)) {
                ...
                $("#tbl_lossand_damages tbody tr:not(.sub-row)").each(function () {
                  ...
                  row_data['receiveditemid'] = $(this).data('receiveditemid');
                  $(this).find("td").each(function (index, cell) {
                    if (index === 1) {
