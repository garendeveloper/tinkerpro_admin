<style>
    ...
    #tbl_expirationItems td:nth-child(4) {
        width: 20px;
        height: 8px;
    }

    #tbl_expirationItems td:nth-child(5) {
        width: 40px;
        height: 8px;
    }

    #tbl_expirationItems td:nth-child(6) {
        width: 3px;
        height: 8px;
    }
</style>
            ...
            <table id="tbl_expirationItems" class="text-color ">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: #1E1C11;">STATUS</th>
                    </tr>
                </thead>
                <tbody style="border-collapse: collapse; ">
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" name="first_expiration" id="first_expiration"
                                    checked>
                                <span class="slider round"></span>
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" name="second_expiration" id="second_expiration"
                                    checked>
                                <span class="slider round"></span>
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" name="third_expiration" id="third_expiration"
                                    checked>
                                <span class="slider round"></span>
                            </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" name="fourth_expiration" id="fourth_expiration"
                                    checked>
                                <span class="slider round"></span>
                            </label>
                        </td>
