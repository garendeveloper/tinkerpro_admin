        ...
        {   
            ...
            ?> 
                <tr  data-id = '<?= $row['id'] ?>' data-product_id = '<?= $row['product_id']?>' class = "tbl_rows">
                    ...
                    <td style = "width: 16%; cursor: pointer;"><?= $row['item_name'] === "" ? $row['product'] : $row['item_name']?></td>
                    ...
                    <td style = "width: 8%; cursor: pointer;" class = "center"><?= $row['expense_type'] ?></td>
                    <td style = "width: 4%; cursor: pointer;"  class = "text-center"><?= $row['uom_name']?></td>
                    <td style = "width: 12%; cursor: pointer;"   class = "text-center" ><?= $row['supplier']?></td>
                    <td style = "width: 7%; cursor: pointer;" class = "text-center"><?= $row['invoice_number']?></td>
                    <td style = "width: 6%; cursor: pointer;" class = "text-right"><?= number_format($row['quantity'], 2)?></td>
                    ...
                    <td style = "width: 7%; cursor: pointer;" class = "text-right"><?= number_format($row['total_amount'], 2)?></td>
