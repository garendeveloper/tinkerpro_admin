...
//   var_dump( $row)
    ...
    <td class='text-center action-td td-h'><?= $row['name'] ?? null ?></td>
    <td class='text-center action-td td-h'><?= $row['contact'] ?? null ?></td>
    <td class='text-center action-td td-h'><?= $row['email'] ?? null ?></td>
    <td class='text-center action-td td-h'><?= $row['company'] ?? null ?></td>
